...
<html ng-app="angular">
    ...
    <body ng-controller="levelOneController">
        <%@include file="../WEB-INF/jspf/header.jspf" %>
        <div class="container">
            <h1 class="text-center">Area Nivel 1</h1>
        ...
        <script src="<%=request.getContextPath()%>/res/scripts/controllers/levelOneController.js" type="text/javascript"></script>
    </body>
</html>
